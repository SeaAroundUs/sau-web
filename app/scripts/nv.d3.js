    ...
    function chart(selection) {
        selection.each(function(data) {
            ...
            if (align) {
                ...
                series
                    .attr('transform', function(d, i) {
                        return 'translate(' + xPositions[i % seriesPerRow] + ',' + (5 + Math.floor(i / seriesPerRow) * 75) + ')';
                    });
                ...
                height = margin.top + margin.bottom + (Math.ceil(seriesWidths.length / seriesPerRow) * 75);
