...
angular.module('sauWebApp')
  //Runs a regex on the user agent to determine if the user agent is a mobile device.
  .factory('isMobileDevice', function($window) {
    var isMobile = false;
    var a = $window.navigator.userAgent||$window.navigator.vendor||$window.opera;
    //Grab the latest from http://detectmobilebrowsers.com
