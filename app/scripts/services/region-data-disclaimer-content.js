...
angular.module('sauWebApp')
  .factory('regionDataDisclaimerContent', function() {
    var masterDisclaimer = '<b>Note</b>: The data we present (\'reconstructed data\') combine official reported data and ' +
      ...
      '<b>For background information on reconstruction data, download the .pdf file for the ' +
      'specific EEZ(s) and also examine our <a href="/catch-reconstruction-and-allocation-methods/">methods</a> ' +
      'for data and spatial allocation.</b>';
