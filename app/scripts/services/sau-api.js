...
angular.module('sauWebApp')
  .factory('sauAPI', function ($resource, SAU_CONFIG, $http) {
    ...
    var methods = {
      ...
      Freshwater: resourceFactory('freshwater/:region_id'),
      FreshwaterSubEntity: resourceFactory('freshwater/sub/:region_id'),
      FreshwaterHasSubEntity: resourceFactory('freshwater/hse/:region_id'),
      FreshwaterData: resourceFactory('freshwater/:dimension/:entity_id'),
      ...
      MPAData: resourceFactory('mpa/:region_id'),
      MPAQuoteData: resourceFactory('mpa/quote/:region_id'),
      MPANamesData: resourceFactory('mpa/names/:region_id'),
